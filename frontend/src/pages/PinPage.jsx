...
import { PinData } from "../context/pinContext.jsx";
            ...
            <div className="bg-white rounded-lg shadow-lg flex flex-wrap w-full max-w-4xl">
              ...
              <div className="w-full md:w-1/2 p-6 flex flex-col ">
                ...
                {edit && (
                  <button
                    style={{ width: "200px" }}
                    className="bg-red-500 text-white py-1 px-3 mt-2 mb-2 rounded-md"
                        ...
                        <div className="flex items-center mb-4 justify-center gap-3 ">
                          ...
                          {e.user === user._id && (
                            <button
                              ...
                              className="bg-red-500 text-white py-1 px-3 rounded ml-16"
                            >
                              <MdDelete />
                            </button>
                          )}
