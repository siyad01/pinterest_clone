...
import { LoadinAnimation } from '../components/Loading';
    ...
    <div className='min-h-screen flex items-center justify-center bg-gray-100'>
        <div className='bg-white p-8 rounded-lg shadow-lg w-full max-w-md'>
            ...
            <div className='mb-4'>
                    ...
                    <input type='text' id='name' className='common-input' value={name} onChange={(e) => setName(e.target.value)} required />
                </div>
                <div className='mb-4'>
                ...
                <button type="submit" className='common-btn' disabled={btnLoading}>
                    {btnLoading?<LoadinAnimation />:"Register"}</button>
            </form>
            ...
            <div className='mt-6 text-center'>
                ...
                <div className='mt-4 text-center text-sm'>
                    <span >Already have an account? <Link to="/login" className="font-medium hover:underline">Login</Link></span>
                </div>
            </div>
        </div>
    </div>
